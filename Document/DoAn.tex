...
\usepackage{textcomp} % Hỗ trợ ký hiệu checkmark
...
\chapter{PHÂN TÍCH VÀ KHẢO SÁT YÊU CẦU}
\label{chapter:Related_works}
\subfile{Chuong/2_Phan_tich_va_khao_sat_yeu_cau}
...
\subfile{Chuong/3_Phan_tich_va_thiet_ke_he_thong}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{CÀI ĐẶT VÀ ĐÁNH GIÁ THỰC NGHIỆM}
\label{chapter:Experiment}
\subfile{Chuong/4_Cai_dat_va_danh_gia_thuc_nghiem}
