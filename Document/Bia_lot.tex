...
{\textbf{\Large{Thiết kế và xây dựng ứng dụng quản lý chi tiêu}}\\[1cm]

{\textbf{\large{NGUYỄN KIM NGỌC}}}\\
{\large{ngoc.nk225655@sis.hust.edu.vn}}\\[0.5cm]
...
\resizebox{\textwidth}{!}{%
\begin{tabular}{ll}
\multicolumn{1}{c}{\textbf{Giảng viên hướng dẫn:}} & TS. Vũ Tuyết Trinh \hspace{0.5cm} \underline{\hspace{3cm}}  \\[0.5cm]
